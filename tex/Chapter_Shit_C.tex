...
\end{itemize}
Erweiterungen am Sprachkern, die neue Schlüsselwörter erfordern, verwenden dafür ebenfalls Namen aus diesem reservierten Bereich, um zu vermeiden, dass sie mit Bezeichnern in existierenden C-Programmen kollidieren, z. B. \displaycode{\_\_attribute\_\_}, \displaycode{\_Complex}, \displaycode{\_Generic}.
