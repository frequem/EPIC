\section{Software}\displayauthor{Florian Weinzerl}\ \\
...
\input{Chapter_Soft_GUI}
%\newpage
\input{Chapter_Soft_Math}

\input{Chapter_Soft_MathGUI}

\input{Chapter_Soft_Arduino}

\input{Chapter_Soft_Raspberry}