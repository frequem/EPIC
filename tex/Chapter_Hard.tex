...
\displayimage{img/frequem/model_bottom}{Unterseite des Gehäuses}{Unterseite des Gehäuses}{0.8}
\displayimage{img/frequem/model_top}{Oberseite des Gehäuses}{Oberseite des Gehäuses}{0.8}
\displayimage{img/frequem/model_button}{Ein- und Ausschaltknopf}{Ein- und Ausschaltknopf}{0.8}
