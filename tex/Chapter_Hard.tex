...
\displayimageg{img/frequem/model_bottom}{Unterseite des Gehäuses}
\displayimageg{img/frequem/model_top}{Oberseite des Gehäuses}
\displayimageg{img/frequem/model_button}{Ein- und Ausschaltknopf}
